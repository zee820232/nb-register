...
func (c *emailServiceClient) WaitForEmail(ctx context.Context, in *WaitForEmailRequest, opts ...grpc.CallOption) (*WaitForEmailResponse, error) {
	...
	out := new(WaitForEmailResponse)
	err := c.cc.Invoke(ctx, EmailService_WaitForEmail_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _EmailService_WaitForEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(WaitForEmailRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EmailServiceServer).WaitForEmail(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EmailService_WaitForEmail_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EmailServiceServer).WaitForEmail(ctx, req.(*WaitForEmailRequest))
	}
